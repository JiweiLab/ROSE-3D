function [lp1, lp2, resultp1, resultp2, resultx, resulty, resultdx, resultdy, A] ...
    = CalculatePhaseAndFineXY_3d_XYZTcomp(x, y, p1, p2, fdata, samplelength)
...
if nargin < 7 || isempty(samplelength)
    samplelength = 5000;
end
...
[lp1, resultp1] = SearchPhasePlane6_CompTest(x,y,p1,fdata,samplelength,[1.55 1.65]);
title('Fitting P1');

disp('Fitting Phase Plane 2 ..');
[lp2, resultp2] = SearchPhasePlane6_CompTest(x,y,p2,fdata,samplelength,[-0.05 0.05]);%[-1.7 -1.4] for EM, [1.4 1.6] for Conventional
title('Fitting P2');
